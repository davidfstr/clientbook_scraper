...
- There exists a "dist/Clientbook Viewer.app" which can be opened to:
  ...
  - Show a minimal UI that says something like "Visit Clientbook in your web browser: http://localhost:8080/", where the URL is a blue link that if clicked opens a web browser.
